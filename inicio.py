...
def main():
    global imagen_original, canvas, notebook, pestana2
    ...
    marco_navegacion.grid_rowconfigure(4, weight=1)
    ...
    boton_pestana3.grid(row=3, column=0, sticky="ew", padx=10, pady=5)
